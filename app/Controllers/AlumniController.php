...
if (! $isAlumni) {
    ...
    return redirect()
        ...
        /*
         * Sementara tetap mempertahankan pola
         * dashboard mahasiswa.
         *
         * Nanti kalau dashboard alumni sudah memakai
         * draft dari database, bagian ini bisa dihapus.
         */
        $drafts = session()->get(
            'alumni_drafts'
        ) ?? [];
