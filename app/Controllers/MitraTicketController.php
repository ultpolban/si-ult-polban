...
class MitraTicketController extends BaseController
{
    ...
    public function create()
    {
        ...
        // =====================================================
        // AMBIL PROFILE MITRA DARI DATABASE
        // =====================================================
        ...
        $pemohon = [
            ...
            'instansi' => $profile['institution_name']
    ...
    public function saveDraft()
    {
        ...
        $ticketNumber = 'ULT-MIT-' . strtoupper(
...
$builder->where('sr.deleted_at', null);
        ...
        // Hanya draft milik mitra yang sedang login
        if (empty($userProfileId)) {
            return redirect()
                ->to(base_url('login'))
                ->with(
    ...
    public function draftSuccess()
    {
        ...
        return view('mitra/ticket/draft_success', [
    ...
    public function success()
    {
        ...
        if (!$ticket) {
            return redirect()->to(
                base_url('mitra/ticket/create')
            );
        }

        return view('mitra/ticket/success', [
    ...
    public function history()
    {
        ...
        if (!$userProfile) {
            return redirect()
                ->to(base_url('mitra/dashboard'))
                ->with('error', 'Data profil mitra tidak ditemukan.');
        }


        // ==========================================
        // AMBIL TIKET MILIK MITRA
        // ==========================================
    ...
    public function detail($id)
    {
        ...
        if (empty($userProfileId)) {
            return redirect()
                ->to(base_url('mitra/ticket/history'))
                ->with('error', 'Data profil mitra tidak ditemukan.');
        }
    ...
    public function reply($id)
    {
        ...
        return redirect()->to(
            base_url('mitra/ticket/detail/' . $id)
        );
    }
}
