...
class CreateJurusanTicketsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'unit_name' => ['type' => 'VARCHAR', 'constraint' => 100, 'default' => 'Jurusan'],
        ...
        $this->forge->createTable('jurusan_tickets', true);
    }

    public function down()
    {
        $this->forge->dropTable('jurusan_tickets', true);
    }
}
