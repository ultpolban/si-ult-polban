...
class CreateJurusanActivityLogsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->createTable('jurusan_activity_logs', true);
    }

    public function down()
    {
        $this->forge->dropTable('jurusan_activity_logs', true);
    }
}
