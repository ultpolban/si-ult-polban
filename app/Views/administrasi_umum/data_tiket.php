...
<div class="data-header">
    ...
    <p class="data-subtitle">
        Daftar tiket layanan yang masuk ke
        <?= esc($nama_unit ?? 'Administrasi Umum') ?>
    </p>
                ...
                <?php foreach ($tiket as $row): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span
                                class="badge-status <?= esc($statusClass) ?>"
                            >
