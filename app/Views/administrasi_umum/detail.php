...
<div class="detail-header">
    ...
    <p class="detail-subtitle">
        Informasi lengkap mengenai pengajuan tiket layanan Administrasi Umum
    </p>
    ...
    <div class="detail-card-body">
            ...
            <div class="detail-item">
                ...
                */
                ...
                if (
                    ...
                    $decodedResultFile = json_decode(
                        $resultFile,
                        true
                    );


                    if (is_array($decodedResultFile)) {
                        ...
                        $hasilLayanan = [
                            [
                                'nama_file' => $resultFile,
                                'nama_asli' => basename($resultFile)
                            ]
                        ];
        ...
        <div class="detail-actions">
            ...
            <?php if ($statusBisaKirim): ?>
                ...
                <a
                    href="<?= base_url(
                        'administrasi-umum/kirim-pemohon/' . $id
                    ) ?>"
