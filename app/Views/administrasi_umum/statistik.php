...
<?php
    // =====================================================
    // DATA STATISTIK ADMINISTRASI UMUM
    // Semua data berasal dari modul Administrasi Umum
    // =====================================================
    ...
    // Nama unit khusus Administrasi Umum
    $unit = 'Administrasi Umum';

    // URL khusus Administrasi Umum
    $dataTiketUrl = $dataTiketUrl
        ?? base_url('administrasi-umum/data-tiket');

    // Pastikan persentase tidak lebih dari 100%
    $persentaseSelesai = min(
        100,
        max(0, $persentaseSelesai)
    );
?>
...
<div class="statistik-page">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table stat-table">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($statistikLayanan as $row): ?>
    ...
    <div class="alert alert-info border-0 shadow-sm">
        ...
        <strong>Selesai</strong> untuk
        <strong>Administrasi Umum</strong>.
