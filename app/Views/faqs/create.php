    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('faqs/store') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="category" class="form-control" value="<?= old('category') ?>" placeholder="Misal: Layanan Umum, Pengaduan, dll">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="answer" rows="4" class="form-control" required><?= old('answer') ?></textarea>
            </div>
