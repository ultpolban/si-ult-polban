...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <p class="dashboard-subtitle">
            Selamat datang,
            <strong><?= esc(session()->get('name') ?? 'Petugas Jurusan') ?></strong>
            👋
        </p>
    </div>
...
<div class="card mb-4 dashboard-overview-card">
    ...
    <div class="card-body d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="mb-0 text-muted">
                    Lihat dan kelola seluruh tiket yang masuk ke Unit Layanan Jurusan.
                </p>
        ...
        <a href="<?= base_url('jurusan/data-tiket') ?>"
...
<div class="card mb-4 dashboard-overview-card">
    ...
    <div class="card-body">
        ...
        <p class="text-muted small mb-3">
            ...
            Ringkasan statistik tiket Unit Jurusan
        ...
        <div class="status-item">
            ...
            <strong>
                ...
                <?= $jumlahMenunggu ?> tiket (<?= $persenMenunggu ?>%)
        ...
        <div class="status-item">
            ...
            <strong>
                ...
                <?= $jumlahDiproses ?> tiket (<?= $persenDiproses ?>%)
        ...
        <div class="status-item">
            ...
            <strong>
                ...
                <?= $jumlahSelesai ?> tiket (<?= $persenSelesai ?>%)
