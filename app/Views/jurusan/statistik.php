...
<?php
    ...
    | DATA KHUSUS JURUSAN
    |--------------------------------------------------------------------------
    | Tidak mengambil fallback data dari Akademik.
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | HITUNG PERSENTASE JIKA BELUM DIKIRIM CONTROLLER
    |--------------------------------------------------------------------------
    */

    if (
        !isset($persentaseSelesai)
        || $persentaseSelesai === 0
    ) {
        if ($totalTiket > 0) {
            $persentaseSelesai =
...
<div class="statistik-page">
    ...
    <div class="stat-header">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <!-- =================================================
                 BUTTON DATA TIKET KHUSUS JURUSAN
            ================================================== -->
            ...
            <div class="stat-main-card h-100">
                ...
                <div class="stat-card-header">
                    ...
                    <h5>
                        ...
                        Ringkasan Status Tiket Jurusan
    ...
    <div class="stat-main-card mb-4">
        ...
        <div class="stat-card-header">
            ...
            <h5>
                ...
                Statistik Berdasarkan Layanan Jurusan
            ...
            <?php else: ?>
                ...
                <div class="text-center p-5">
                    ...
                    <h5 class="text-muted">
                        ...
                        Belum ada data statistik Jurusan

                    </h5>

                    <p class="text-muted mb-0">

                        Belum terdapat tiket Jurusan
    ...
    <div class="alert alert-info border-0 shadow-sm">
        ...
        Statistik ini khusus menampilkan data tiket
        <strong>Unit Layanan Jurusan</strong> berdasarkan
