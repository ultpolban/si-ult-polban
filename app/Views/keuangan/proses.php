...
<title><?= $title ?? 'Proses Tiket Keuangan' ?></title>
...
<form action="<?= base_url('keuangan/updateProses/'.$tiket['id']) ?>"
method="post"
...
<a href="<?= base_url('uploads/hasil/'.$dokumen['nama_file']) ?>"
target="_blank">
...
<a href="<?= base_url('keuangan/hapus-dokumen/'.$dokumen['id']) ?>"
...
<a href="<?= base_url('keuangan/detail/'.$tiket['id']) ?>"
...
alert(
'Ukuran '+file.name+' maksimal 5 MB'
);
