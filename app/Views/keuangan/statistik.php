...
<?php
    ...
    */
    ...
    $pctMenunggu = $totalTiket > 0
        ? round(($menunggu / $totalTiket) * 100)
        : 0;

    $pctDiproses = $totalTiket > 0
        ? round(($diproses / $totalTiket) * 100)
        : 0;

    $pctSelesai = $totalTiket > 0
    ...
    */
    ...
    if (!isset($persentaseSelesai) || $persentaseSelesai === null) {
        $persentaseSelesai = $pctSelesai;
    }

    $persentaseSelesai = (float) $persentaseSelesai;
...
<!-- =====================================================
     RINGKASAN STATUS + TINGKAT PENYELESAIAN
===================================================== -->
