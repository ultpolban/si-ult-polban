...
<div class="content-wrapper">
    ...
    <form
        action="<?= base_url('mitra/ticket/store') ?>"
        method="post"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">
                                ...
                                Instansi/perusahaan diambil dari data profil Mitra.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">
                                ...
                                Jabatan diambil dari data profil Mitra.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">
                                ...
                                Email diambil dari data akun dan tidak dapat diubah.
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div>
                        ...
                        <button
                            ...
                            value="draft"
                            formnovalidate
                            formaction="<?= base_url('mitra/ticket/save-draft') ?>"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        `;
            ...
            fetch(
                    '<?= base_url('mitra/ticket/jenis-layanan') ?>?unit_id=' +
        ...
        `;
            ...
            fetch(
                    '<?= base_url('mitra/ticket/persyaratan') ?>?service_id=' +
