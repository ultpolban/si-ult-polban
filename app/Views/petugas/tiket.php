...
function ticketPageUrl($page, $queryParams = []) {
    ...
    return base_url('datatiket?' . http_build_query($queryParams));
}
?>
                ...
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?= base_url('datatiket') ?>" class="btn btn-ticket-reset" title="Reset Filter">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 export-action-group">
                        <div class="export-dropdown">
                            ...
                            <div class="export-menu" id="exportMenu">
                                <a class="dropdown-item" href="<?= base_url('report/excel') ?>"><i class="fas fa-file-excel mr-2" style="color:#0B8F4D;"></i> Export Excel</a>
                                <a class="dropdown-item" href="<?= base_url('report/pdf') ?>"><i class="fas fa-file-pdf mr-2" style="color:#D93025;"></i> Export PDF</a>
                                <a class="dropdown-item" href="<?= base_url('report/csv') ?>"><i class="fas fa-file-csv mr-2" style="color:#005BAC;"></i> Export CSV</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="ticket-actions">
                                        ...
                                        <a href="<?= base_url('datatiket/detail/' . esc($ticket['id'] ?? $ticket['nomor_tiket'])) ?>" class="ticket-action action-detail" title="Detail Tiket">
                                            <i class="fas fa-eye"></i>
                                        </a>

                                        <?php if ($st === 'submitted'): ?>
                                            <!-- BELUM DIVERIFIKASI -> AKSI VERIFIKASI -->
                                            <a href="<?= base_url('verification/verify/' . esc($ticket['id'] ?? $ticket['nomor_tiket'])) ?>" class="ticket-action action-verify" title="Verifikasi Tiket">
                                                <i class="fas fa-user-check"></i>
                                            </a>
                                        <?php elseif ($st === 'verified'): ?>
                                            <!-- SUDAH DIVERIFIKASI -> AKSI DISPOSISI -->
                                            <a href="<?= base_url('disposition/create/' . esc($ticket['id'] ?? $ticket['nomor_tiket'])) ?>" class="ticket-action action-disposition" title="Disposisi Tiket">
