...
<div class="container-fluid py-2" style="max-width: 700px; margin: 0 auto;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-1">Tambah Role</h3>
            <p class="text-muted mb-0">Tambahkan role pengguna baru ke sistem</p>
        </div>
    ...
    <div class="card card-premium">
        <div class="card-header border-bottom-0 py-3" style="background: linear-gradient(135deg, #1e2f99 0%, #1e3a60 100%); border-radius: 14px 14px 0 0;">
            <h5 class="text-white font-weight-bold m-0" style="font-size: 1.05rem;">Tambah Role</h5>
        </div>
