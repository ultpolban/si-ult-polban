...
<div class="content-wrapper">
    ...
    <form
        action="<?= base_url('umum/ticket/store') ?>"
        method="post"
                ...
                >
                    ...
                    <div>
                        ...
                        <button
                            ...
                            value="draft"
                            formnovalidate
                            formaction="<?= base_url('umum/ticket/save-draft') ?>"
    ...
    function () {
        ...
        unitSelect.addEventListener(
            ...
            function () {
                ...
                fetch(
                    '<?= base_url('umum/ticket/jenis-layanan') ?>?unit_id='
                    +
        ...
        jenisSelect.addEventListener(
            ...
            function () {
                ...
                fetch(
                    '<?= base_url('umum/ticket/persyaratan') ?>?service_id='
                    +
