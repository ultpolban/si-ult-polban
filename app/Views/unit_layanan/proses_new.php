...
<body>
    <div class="container mt-4">
        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="<?= base_url('unit-layanan/updateProses/' . $tiket['id']) ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                            ...
                            <ul class="mt-2">
                                <?php foreach ($tiket['dokumen_hasil'] as $dokumen): ?>
                                    <li class="mb-2">
                                        ...
                                        <a href="<?= base_url('unit-layanan/hapus-dokumen/' . $dokumen['id']) ?>" class="btn btn-danger btn-sm ms-2" onclick="return confirm('Hapus dokumen ini?')">
                                            ×
                                        </a>
                                    </li>
                                <?php endforeach; ?>
