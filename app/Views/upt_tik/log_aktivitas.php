...
<?php
    ...
    |--------------------------------------------------------------------------
    | Halaman ini khusus UPT TIK.
    |
    | Saat ini belum ada tiket UPT TIK, sehingga belum ada data
    | log aktivitas yang ditampilkan.
    |
    | Tampilan tetap disiapkan agar nanti data log dapat ditampilkan
    | setelah proses tiket UPT TIK berjalan.
    |--------------------------------------------------------------------------
    */
